...
layout = [[psg.Text("Welcome to the carbon emissions calculator!")],
          [psg.Text("This is a system to help you figure out your personal CO2 emmissions and the environmental impact you have in a year.")],
...
total = str((userElectrical*0.23314)+userDrive+(userPlane*90))
